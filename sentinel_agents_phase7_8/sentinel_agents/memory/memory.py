"""JSON‑backed memory store for execution traces (Phase 7 & 8).
...
This is intentionally lightweight—use a proper database or vector
store for production scenarios.
"""
