"""Basic policy engine for Sentinel Agents Phase 7 & 8.
...
learning and governance layers can adjust the blocked keywords via
`update_policy`.  This is identical to the Phase 6 implementation and
serves as a simple example of policy enforcement.
"""
...
class PolicyEngine:
    ...
    def update_policy(self, blocked_keywords: Iterable[str]) -> None:
        ...
        The learning layer or governance logic can call this method to
        introduce new restrictions based on feedback from previous
        executions.  The update is additive—existing blocked keywords
        will persist.
        """
