"""Naive risk scoring engine.

The `RiskEngine` assigns a risk score between 0 and 1.  Tasks containing
configured risky keywords are assigned higher scores.  A maximum allowed
risk threshold can be specified when constructing the engine.
"""
