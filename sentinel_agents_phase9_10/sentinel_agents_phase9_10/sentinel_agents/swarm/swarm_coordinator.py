...
`AgentRuntime` instances and dispatches a task to each in order.
Each agent processes the task independently.  The results are
collected and returned.  Unchanged from earlier phases.
"""
